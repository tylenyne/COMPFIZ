...
public class TerrainRender implements _IRenders {
    ...
    public void init() throws Exception{
        shadeMan.createVertexShader(Utils.loadResource("/shaders/terrain_vertex.vsh"));
        shadeMan.createFragmentShader(Utils.loadResource("/shaders/terrain_fragment.fsh"));
        shadeMan.link();
    ...
    public void prepare(Object terrain, Camera camera){
        ...
        shadeMan.setUniform("transformationMatrix", Transformation.createTransformationMatrix((Terrain) terrain));
